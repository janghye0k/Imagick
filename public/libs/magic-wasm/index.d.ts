...
export interface IMagickImageCollection extends Array<IMagickImage>, IDisposable {
  ...
  evaluate<TReturnType>(
    ...
    func: AsyncImageCallback<TReturnType>
  ): Promise<TReturnType>;
...
export type ImageCollectionCallback<TReturnType> = (
...
export interface IMagickImage extends IDisposable {
  ...
  compare<TReturnType>(
    ...
    func: (compareResult: CompareResult) => TReturnType
  ): TReturnType;
  compare<TReturnType>(
    image: IMagickImage,
    settings: CompareSettings,
    func: (compareResult: CompareResult) => Promise<TReturnType>
  ): Promise<TReturnType>;
  compare<TReturnType>(
    image: IMagickImage,
    settings: CompareSettings,
...
export declare class MagickImage extends NativeInstance implements IMagickImage {
  ...
  compare<TReturnType>(
    image: IMagickImage,
    metric: ErrorMetric,
    func: (image: CompareResult) => TReturnType
  ): TReturnType;
  compare<TReturnType>(
    image: IMagickImage,
    metric: ErrorMetric,
    func: (image: CompareResult) => Promise<TReturnType>
  ): Promise<TReturnType>;
  compare<TReturnType>(
    image: IMagickImage,
    metric: ErrorMetric,
    channels: Channels,
    func: (result: CompareResult) => TReturnType
  ): TReturnType;
  compare<TReturnType>(
    image: IMagickImage,
    metric: ErrorMetric,
    channels: Channels,
    func: (result: CompareResult) => Promise<TReturnType>
  ): Promise<TReturnType>;
  composite(image: IMagickImage): void;
  composite(image: IMagickImage, compose: CompositeOperator): void;
  composite(image: IMagickImage, compose: CompositeOperator, channels: Channels): void;
  ...
  cropToTiles<TReturnType>(
    geometry: IMagickGeometry,
    func: AsyncImageCollectionCallback<TReturnType>
  ): Promise<TReturnType>;
...
export declare class ImageMagick {
  ...
  static read<TReturnType>(
    ...
    width: number,
    height: number,
    func: SyncImageCallback<TReturnType>
  ): TReturnType;
  static read<TReturnType>(
    color: IMagickColor,
    width: number,
  ...
  static readCollection<TReturnType>(
    array: ByteArray,
    format: MagickFormat,
    func: SyncImageCollectionCallback<TReturnType>
  ): TReturnType;
  static readCollection<TReturnType>(
    array: ByteArray,
    format: MagickFormat,
...
export declare function initializeImageMagick(
  wasmLocationDataOrAssembly: URL | ByteArray | WebAssembly.Module,
  configurationFiles?: IConfigurationFiles
): Promise<void>;
...
export declare class OffsetInfo {
  static _use<TReturnType>(
    x: number,
    y: number,
    func: (primaryInfoPtr: number) => TReturnType | Promise<TReturnType>
  ): TReturnType | Promise<TReturnType>;
}

export { ProgressEvent$1 as ProgressEvent };
