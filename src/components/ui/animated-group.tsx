...
function AnimatedGroup({ children, className, variants, preset, as = 'div', asChild = 'div' }: AnimatedGroupProps) {
  ...
  const MotionComponent = React.useMemo(() => motion.create(as as string | React.ComponentType<any>), [as]);
  const MotionChild = React.useMemo(() => motion.create(asChild as string | React.ComponentType<any>), [asChild]);
