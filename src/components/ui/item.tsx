...
function ItemContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('gap-1 flex flex-1 flex-col [&+[data-slot=item-content]]:flex-none', className)}
      {...props}
    />
  );
}
...
function ItemTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('gap-2 text-sm leading-snug font-medium flex w-fit items-center', className)}
      {...props}
    />
  );
}
...
function ItemDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-sm leading-normal font-normal line-clamp-2 text-balance text-muted-foreground',
